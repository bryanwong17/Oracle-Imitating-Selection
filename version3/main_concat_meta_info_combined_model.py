...
parser.add_argument("--sched", default="step_lr", type=str,
...
def main():
    ...
    for seed in args.seeds:
        ...
        if args.upsampled_train:
            ...
            train_df = train_df.sample(frac=1, randomn_state=seed).reset_index(drop=True)
        ...
        model = OracleImitationModel(feature_extractor, input_dim=519, output_dim=args.num_classes)
        ...
        actual_labels, predicted_labels, predicted_scores = test_model(valid_df, args.image_size, args.batch_size, model, device)
