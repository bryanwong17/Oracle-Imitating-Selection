...
def test_model(test_df, image_size, batch_size, model, device):

    test_dataset = PatchesDataset(test_df, image_size, is_train=False)
...
def fit_gpu(image_size, batch_size, model, save_results_path, epochs, device, criterion, optimizer, scheduler, train_loader, valid_df=None):
