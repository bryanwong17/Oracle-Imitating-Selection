...
# run default seed (0): python main.py
# run default seed (0) with upsampled train and downsampled valid: python main.py --upsampled_train --downsampled_valid
# run default seed (0) with upsampled train and downsampled valid and a specific model: python main.py --upsampled_train --downsampled_valid --model=vgg16
# run multiple seeds: python main.py --seeds 0 10 100 1000 10000
# run multiple seeds with upsampled train and downsampled valid: python main.py --seeds 0 10 100 1000 10000 --upsampled_train --downsampled_valid
# run multiple seeds with upsampled train and downsampled valid and a specific model: python main.py --seeds 0 10 100 1000 10000 --upsampled_train --downsampled_valid --model=vgg16
...
def main():
    ...
    for seed in args.seeds:
        ...
        args.save_results_path = os.path.join(args.save_results_path, f"seed_{seed}", f"{args.model}")
