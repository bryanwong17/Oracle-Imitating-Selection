    ...
    for seed in args.seeds:
        ...
        if args.use_sched:
            if args.sched == "exponential_lr":
                ...
                feature_extractor_scheduler = torch.optim.lr_scheduler.StepLR(feature_extractor_optimizer, step_size=args.step_size, gamma=args.gamma)
                oracle_imitation_scheduler = torch.optim.lr_scheduler.StepLR(oracle_imitation_optimizer, step_size=args.step_size, gamma=args.gamma)
        else:
